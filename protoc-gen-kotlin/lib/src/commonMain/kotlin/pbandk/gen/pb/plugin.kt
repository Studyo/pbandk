...
data class Version(
    ...
    companion object : pbandk.Message.Companion<Version> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): Version { throw UnsupportedOperationException("Json support is disabled")
 }
    }
...
data class CodeGeneratorRequest(
    ...
    companion object : pbandk.Message.Companion<CodeGeneratorRequest> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): CodeGeneratorRequest { throw UnsupportedOperationException("Json support is disabled")
 }
    }
...
data class CodeGeneratorResponse(
    ...
    companion object : pbandk.Message.Companion<CodeGeneratorResponse> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): CodeGeneratorResponse { throw UnsupportedOperationException("Json support is disabled")
 }
    }
    ...
    data class File(
        ...
        companion object : pbandk.Message.Companion<CodeGeneratorResponse.File> {
            ...
            override fun jsonUnmarshal(json: Json, data: String): CodeGeneratorResponse.File { throw UnsupportedOperationException("Json support is disabled")
 }
        }
