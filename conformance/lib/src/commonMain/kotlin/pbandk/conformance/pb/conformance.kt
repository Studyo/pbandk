...
data class FailureSet(
    ...
    companion object : pbandk.Message.Companion<FailureSet> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): FailureSet { throw UnsupportedOperationException("Json support is disabled")
 }
    }
...
data class ConformanceRequest(
    ...
    companion object : pbandk.Message.Companion<ConformanceRequest> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): ConformanceRequest { throw UnsupportedOperationException("Json support is disabled")
 }
    }
...
data class ConformanceResponse(
    ...
    companion object : pbandk.Message.Companion<ConformanceResponse> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): ConformanceResponse { throw UnsupportedOperationException("Json support is disabled")
 }
    }
...
data class JspbEncodingConfig(
    ...
    companion object : pbandk.Message.Companion<JspbEncodingConfig> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): JspbEncodingConfig { throw UnsupportedOperationException("Json support is disabled")
 }
    }
