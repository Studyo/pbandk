...
data class Struct(
    ...
    companion object : pbandk.Message.Companion<Struct> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): Struct { throw UnsupportedOperationException("Json support is disabled")
 }
    }
    ...
    data class FieldsEntry(
        ...
        companion object : pbandk.Message.Companion<Struct.FieldsEntry> {
            ...
            override fun jsonUnmarshal(json: Json, data: String): Struct.FieldsEntry { throw UnsupportedOperationException("Json support is disabled")
 }
        }
...
data class Value(
    ...
    companion object : pbandk.Message.Companion<Value> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): Value { throw UnsupportedOperationException("Json support is disabled")
 }
    }
...
data class ListValue(
    ...
    companion object : pbandk.Message.Companion<ListValue> {
        ...
        override fun jsonUnmarshal(json: Json, data: String): ListValue { throw UnsupportedOperationException("Json support is disabled")
 }
    }
